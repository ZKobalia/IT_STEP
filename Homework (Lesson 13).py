...
print("Student's ID:  20, 25, 100, 56, 1232, 846723")
id = int(input("Get Student's ID: "))
...
for student in my_dict['students']:
  ...
  if st_id == id:
    print(f"Student ID: {st_id}, Name: {st_name}, Age: {st_age}")

for subject in my_dict['subjects']:
    
  st_subject = subject.get('name')
  st_grade = subject['grades'].get(str(id))
